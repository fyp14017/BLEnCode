 ...
 */
package hku.fyp14017.blencode.test.cucumber;
...
import hku.fyp14017.blencode.test.cucumber.util.PrintBrick;

import hku.fyp14017.blencode.ProjectManager;
import org.fyp14017.blencode.content.*;
import org.fyp14017.blencode.content.bricks.*;
import hku.fyp14017.blencode.formulaeditor.Formula;
import org.fyp14017.blencode.formulaeditor.FormulaElement;
import org.fyp14017.blencode.formulaeditor.UserVariable;
import org.fyp14017.blencode.stage.StageActivity;
import org.fyp14017.blencode.test.cucumber.util.CallbackBrick;
import hku.fyp14017.blencode.test.cucumber.util.PrintBrick;
import org.fyp14017.blencode.test.cucumber.util.Util;
import org.fyp14017.blencode.ui.MainMenuActivity;
import org.fyp14017.blencode.ui.ProjectActivity;
...
import static org.fyp14017.blencode.formulaeditor.FormulaElement.ElementType;
...
public class ProgramSteps extends AndroidTestCase {
	...
	public void program_has_object(String name) {
		int lookId = org.fyp14017.blencode.R.drawable.default_project_mole_1;
		ProjectManager pm = ProjectManager.getInstance();
		Project project = pm.getCurrentProject();
	...
	public void I_start_the_program() throws InterruptedException {
		...
		solo.clickOnView(solo.getView(org.fyp14017.blencode.R.id.main_menu_button_continue));
		...
		solo.clickOnView(solo.getView(org.fyp14017.blencode.R.id.button_play));
