...
public class BeforeAfterSteps extends ActivityInstrumentationTestCase2<MainMenuActivity> {
	...
	public void before() {
		...
		String defaultBackgroundName = context.getString(hku.fyp14017.blencode.R.string.background);
		String defaultProjectName = context.getString(hku.fyp14017.blencode.R.string.default_project_name);
		String defaultSpriteName = context.getString(hku.fyp14017.blencode.R.string.default_project_sprites_mole_name);
