...
public class ProximitySensorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView sensorList = (ListView) findViewById(R.id.sensorView);
        sensorList.setAdapter(adapter);

        Button addSensor = (Button) findViewById(R.id.button2);
        addSensor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View proximityView = li.inflate(R.layout.proximity_sensor, null);
                final EditText name = (EditText) proximityView.findViewById(R.id.editText);
