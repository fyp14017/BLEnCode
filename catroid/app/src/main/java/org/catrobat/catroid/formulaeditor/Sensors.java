...
public enum Sensors {
	X_ACCELERATION, Y_ACCELERATION, Z_ACCELERATION, COMPASS_DIRECTION, X_INCLINATION, Y_INCLINATION, LOUDNESS, FACE_DETECTED, FACE_SIZE, FACE_X_POSITION, FACE_Y_POSITION, OBJECT_X(
			...
			true), OBJECT_LAYER(true), SENSOR_TAG_TEMPERATURE, ACCELEROMETER_ABS, ACCELEROMETER_X, ACCELEROMETER_Y, ACCELEROMETER_Z, GYROSCOPE_X, GYROSCOPE_Y, GYROSCOPE_Z, MAGNETOMETER_ABS, MAGNETOMETER_X, MAGNETOMETER_Y, MAGNETOMETER_Z;
