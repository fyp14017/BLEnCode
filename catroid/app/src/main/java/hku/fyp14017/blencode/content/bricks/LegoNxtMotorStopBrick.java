...
public class LegoNxtMotorStopBrick extends BrickBaseType implements OnItemSelectedListener {
	...
	public View getPrototypeView(Context context) {
		View prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_nxt_motor_stop, null);
		Spinner legoSpinner = (Spinner) prototypeView.findViewById(hku.fyp14017.blencode.R.id.stop_motor_spinner);
		legoSpinner.setFocusableInTouchMode(false);
		legoSpinner.setFocusable(false);

		ArrayAdapter<CharSequence> motorAdapter = ArrayAdapter.createFromResource(context,
				hku.fyp14017.blencode.R.array.nxt_stop_motor_chooser, android.R.layout.simple_spinner_item);
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_nxt_motor_stop, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_nxt_motor_stop_checkbox);
		...
		Spinner motorSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.stop_motor_spinner);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_nxt_motor_stop_layout);
