...
public class SensorTagFragment extends SherlockListFragment implements Dialog.OnKeyListener{
    ...
    private static int[] SensorTagElements = {
            hku.fyp14017.blencode.R.string.ir_temperature, hku.fyp14017.blencode.R.string.sensor_temperature, hku.fyp14017.blencode.R.string.sensor_accelerometer_abs, hku.fyp14017.blencode.R.string.sensor_accelerometer_x,
            hku.fyp14017.blencode.R.string.sensor_accelerometer_y, hku.fyp14017.blencode.R.string.sensor_accelerometer_z, hku.fyp14017.blencode.R.string.sensor_gyroscope_x,
            hku.fyp14017.blencode.R.string.sensor_gyroscope_y, hku.fyp14017.blencode.R.string.sensor_gyroscope_z, hku.fyp14017.blencode.R.string.sensor_magnetometer_abs,
            hku.fyp14017.blencode.R.string.sensor_magnetometer_x, hku.fyp14017.blencode.R.string.sensor_magnetometer_y, hku.fyp14017.blencode.R.string.sensor_magnetometer_z, hku.fyp14017.blencode.R.string.sensor_pressure, hku.fyp14017.blencode.R.string.sensor_humidity
    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View fragmentView = inflater.inflate(hku.fyp14017.blencode.R.layout.fragment_sensor_tag, container, false);
        ...
        if( keyCode == KeyEvent.KEYCODE_BACK )
        {
            ...
            if (fragment == null) {
                ...
                bundle.putString(FormulaEditorListFragment.ACTION_BAR_TITLE_BUNDLE_ARGUMENT,
                        getActivity().getString(hku.fyp14017.blencode.R.string.formula_editor_sensors));
                bundle.putString(FormulaEditorListFragment.FRAGMENT_TAG_BUNDLE_ARGUMENT, FormulaEditorListFragment.SENSOR_TAG);
                fragment.setArguments(bundle);
                fragmentManager.beginTransaction().hide(this).add(hku.fyp14017.blencode.R.id.script_fragment_container, fragment, FormulaEditorListFragment.SENSOR_TAG).commit();
            }else {
