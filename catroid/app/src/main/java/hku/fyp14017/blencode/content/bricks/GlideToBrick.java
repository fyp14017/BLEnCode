...
public class GlideToBrick extends FormulaBrick implements OnClickListener {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_glide_to, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_glide_to_checkbox);
		...
		TextView textX = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_prototype_text_view_x);
		TextView editX = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_edit_text_x);
		getFormulaWithBrickField(BrickField.X_DESTINATION).setTextFieldId(hku.fyp14017.blencode.R.id.brick_glide_to_edit_text_x);
		getFormulaWithBrickField(BrickField.X_DESTINATION).refreshTextField(view);
		editX.setOnClickListener(this);

		TextView textY = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_prototype_text_view_y);
		TextView editY = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_edit_text_y);
		getFormulaWithBrickField(BrickField.Y_DESTINATION).setTextFieldId(hku.fyp14017.blencode.R.id.brick_glide_to_edit_text_y);
		getFormulaWithBrickField(BrickField.Y_DESTINATION).refreshTextField(view);
		editY.setOnClickListener(this);

		TextView textDuration = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_prototype_text_view_duration);
		TextView editDuration = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_edit_text_duration);
		getFormulaWithBrickField(BrickField.DURATION_IN_SECONDS).setTextFieldId(hku.fyp14017.blencode.R.id.brick_glide_to_edit_text_duration);
		getFormulaWithBrickField(BrickField.DURATION_IN_SECONDS).refreshTextField(view);

		TextView times = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_seconds_text_view);
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_glide_to, null);
		TextView textX = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_prototype_text_view_x);
		TextView textY = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_prototype_text_view_y);
		TextView textDuration = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_prototype_text_view_duration);
		TextView times = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_seconds_text_view);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView glideToLabel = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_label);
			TextView glideToSeconds = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_seconds_text_view);
			TextView glideToXTextView = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_x);
			TextView glideToYTextView = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_y);
			TextView editDuration = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_edit_text_duration);
			TextView editX = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_edit_text_x);
			TextView editY = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_glide_to_edit_text_y);
