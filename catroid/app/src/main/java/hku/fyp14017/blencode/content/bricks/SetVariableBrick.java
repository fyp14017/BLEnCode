...
public class SetVariableBrick extends FormulaBrick implements OnClickListener, NewVariableDialogListener {
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_set_variable, null);
		view = getViewWithAlpha(alphaValue);
		setCheckboxView(hku.fyp14017.blencode.R.id.brick_set_variable_checkbox);
		...
		TextView prototypeText = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_set_variable_prototype_view);
		TextView textField = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_set_variable_edit_text);
		prototypeText.setVisibility(View.GONE);
		getFormulaWithBrickField(BrickField.VARIABLE).setTextFieldId(hku.fyp14017.blencode.R.id.brick_set_variable_edit_text);
		getFormulaWithBrickField(BrickField.VARIABLE).refreshTextField(view);
		textField.setVisibility(View.VISIBLE);
		textField.setOnClickListener(this);

		Spinner variableSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.set_variable_spinner);
	...
	public View getPrototypeView(Context context) {
		View prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_set_variable, null);
		Spinner variableSpinner = (Spinner) prototypeView.findViewById(hku.fyp14017.blencode.R.id.set_variable_spinner);
		UserBrick currentBrick = ProjectManager.getInstance().getCurrentUserBrick();
		...
		TextView textSetVariable = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_set_variable_prototype_view);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			TextView textSetVariable = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_set_variable_label);
			TextView textTo = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_set_variable_to_textview);
			TextView editVariable = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_set_variable_edit_text);
			Spinner variablebrickSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.set_variable_spinner);
