...
public class ChangeBrightnessByNBrick extends FormulaBrick implements OnClickListener {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_change_brightness, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_change_brightness_checkbox);
		...
		TextView textX = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_change_brightness_prototype_text_view);
		TextView editX = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_change_brightness_edit_text);
		getFormulaWithBrickField(BrickField.BRIGHTNESS_CHANGE).setTextFieldId(hku.fyp14017.blencode.R.id.brick_change_brightness_edit_text);
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_change_brightness, null);
		TextView textChangeBrightness = (TextView) prototypeView
				.findViewById(hku.fyp14017.blencode.R.id.brick_change_brightness_prototype_text_view);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_change_brightness_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView textBrightness = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_change_brightness_label);
			TextView textBy = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_change_brightness_by_textview);
			TextView editBrightness = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_change_brightness_edit_text);
