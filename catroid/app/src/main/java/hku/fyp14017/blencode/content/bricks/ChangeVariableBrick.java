...
import hku.fyp14017.blencode.ui.adapter.UserVariableAdapter;
import hku.fyp14017.blencode.ui.adapter.UserVariableAdapterWrapper;
import hku.fyp14017.blencode.ui.dialogs.NewVariableDialog;
import hku.fyp14017.blencode.ui.dialogs.NewVariableDialog.NewVariableDialogListener;
...
public class ChangeVariableBrick extends FormulaBrick implements OnClickListener, NewVariableDialogListener {
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_change_variable_by, null);
		view = getViewWithAlpha(alphaValue);
		setCheckboxView(hku.fyp14017.blencode.R.id.brick_change_variable_checkbox);
		...
		TextView prototypeText = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_change_variable_prototype_view);
		TextView textField = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_change_variable_edit_text);
		prototypeText.setVisibility(View.GONE);
		getFormulaWithBrickField(BrickField.VARIABLE_CHANGE).setTextFieldId(hku.fyp14017.blencode.R.id.brick_change_variable_edit_text);
		getFormulaWithBrickField(BrickField.VARIABLE_CHANGE).refreshTextField(view);
		textField.setVisibility(View.VISIBLE);
		textField.setOnClickListener(this);

		Spinner variableSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.change_variable_spinner);
	...
	public View getPrototypeView(Context context) {
		View prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_change_variable_by, null);
		Spinner variableSpinner = (Spinner) prototypeView.findViewById(hku.fyp14017.blencode.R.id.change_variable_spinner);
		...
		TextView textChangeVariable = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_change_variable_prototype_view);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_change_variable_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView textSetVariable = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_change_variable_label);
			TextView textTo = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_change_variable_by);
			TextView editVariable = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_change_variable_edit_text);
			Spinner variablebrickSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.change_variable_spinner);
