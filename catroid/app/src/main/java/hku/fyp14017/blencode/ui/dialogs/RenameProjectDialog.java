...
public class RenameProjectDialog extends TextDialog {
	...
	protected void initialize() {
		...
		inputTitle.setText(hku.fyp14017.blencode.R.string.new_project_name);
	}
	...
	protected boolean handleOkButton() {
		...
		if (newProjectName.equalsIgnoreCase("")) {
			Utils.showErrorDialog(getActivity(), hku.fyp14017.blencode.R.string.notification_invalid_text_entered);
			return false;
		...
		if (newProjectName != null && !newProjectName.equalsIgnoreCase("")) {
			...
			if (oldProjectName.equalsIgnoreCase(currentProjectName)) {
				...
				try {
					...
					Utils.showErrorDialog(getActivity(), hku.fyp14017.blencode.R.string.error_rename_incompatible_project);
					dismiss();
					return false;
				}
			}
	...
	protected String getTitle() {
		return getString(hku.fyp14017.blencode.R.string.rename_project);
	}
