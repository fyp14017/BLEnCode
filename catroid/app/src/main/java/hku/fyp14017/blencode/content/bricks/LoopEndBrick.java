...
public class LoopEndBrick extends BrickBaseType implements NestingBrick, AllowedAfterDeadEndBrick {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		if (view == null) {
			...
			view = inflater.inflate(hku.fyp14017.blencode.R.layout.brick_loop_end, null);
			view = getViewWithAlpha(alphaValue);
			checkbox = (CheckBox) view.findViewById(hku.fyp14017.blencode.R.id.brick_loop_end_checkbox);

			setCheckboxView(hku.fyp14017.blencode.R.id.brick_loop_end_checkbox);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_loop_end_layout);
			if (layout == null) {
				layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_loop_end_no_puzzle_layout);
				TextView loopLabel = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_loop_end_no_puzzle_label);
				loopLabel.setTextColor(loopLabel.getTextColors().withAlpha(alphaValue));
			} else {
				TextView loopLabel = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_loop_end_label);
				loopLabel.setTextColor(loopLabel.getTextColors().withAlpha(alphaValue));
			}
	...
	public View getPrototypeView(Context context) {
		return View.inflate(context, hku.fyp14017.blencode.R.layout.brick_loop_end, null);
	}
	...
	public View getNoPuzzleView(Context context, int brickId, BaseAdapter baseAdapter) {
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		return inflater.inflate(hku.fyp14017.blencode.R.layout.brick_loop_end_no_puzzle, null);
	}
