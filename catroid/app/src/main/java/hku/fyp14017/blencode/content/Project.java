...
public class Project implements Serializable {
	...
	public Project(Context context, String name) {
		...
		Sprite background = new Sprite(context.getString(hku.fyp14017.blencode.R.string.background));
	...
	public void setDeviceData(Context context) {
		...
		if (context == null) {
			...
			xmlHeader.setApplicationName(context.getString(hku.fyp14017.blencode.R.string.app_name));
		}
	}
