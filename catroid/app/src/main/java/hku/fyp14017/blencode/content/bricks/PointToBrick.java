...
public class PointToBrick extends BrickBaseType {
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = inflater.inflate(hku.fyp14017.blencode.R.layout.brick_point_to, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_point_to_checkbox);
		...
		final Spinner spinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.brick_point_to_spinner);
		...
		spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
				...
				if (itemSelected.equals(context.getString(hku.fyp14017.blencode.R.string.new_broadcast_message))) {
					pointedObject = null;
				} else {
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_point_to_layout);
			layout.getBackground().setAlpha(alphaValue);

			TextView textPointToLabel = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_point_to_label);
			textPointToLabel.setTextColor(textPointToLabel.getTextColors().withAlpha(alphaValue));
			Spinner pointToSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.brick_point_to_spinner);
	...
	public View getPrototypeView(Context context) {
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		View view = inflater.inflate(hku.fyp14017.blencode.R.layout.brick_point_to, null);
		Spinner pointToSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.brick_point_to_spinner);
	...
	private ArrayAdapter<String> getArrayAdapterFromSpriteList(Context context) {
		...
		arrayAdapter.add(context.getString(hku.fyp14017.blencode.R.string.new_broadcast_message));
		...
		for (Sprite sprite : spriteList) {
			...
			if (!spriteName.equals(temp) && !spriteName.equals(context.getString(hku.fyp14017.blencode.R.string.background))) {
	...
	public final class SpinnerAdapterWrapper implements SpinnerAdapter {
		...
		public long getItemId(int paramInt) {
			...
			if (!currentSpriteName.equals(context.getString(hku.fyp14017.blencode.R.string.new_broadcast_message))) {
		...
		public void refreshSpinnerAfterNewSprite(final Context context, final String newSpriteName) {
			...
			AlertDialog dialog = new CustomAlertDialogBuilder(context)
					.setTitle(hku.fyp14017.blencode.R.string.dialog_new_object_switch_title)
					.setMessage(hku.fyp14017.blencode.R.string.dialog_new_object_switch_message)
