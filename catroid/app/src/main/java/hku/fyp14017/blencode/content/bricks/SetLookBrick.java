...
import hku.fyp14017.blencode.ui.fragment.LookFragment.OnLookDataListChangedAfterNewListener;
...
public class SetLookBrick extends BrickBaseType implements LookFragment.OnLookDataListChangedAfterNewListener {
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_set_look, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_set_look_checkbox);
		...
		final Spinner lookbrickSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.brick_set_look_spinner);
		...
		if (ProjectManager.getInstance().getCurrentSprite().getName().equals(context.getString(hku.fyp14017.blencode.R.string.background))) {
			TextView textField = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_set_look_prototype_text_view);
			textField.setText(hku.fyp14017.blencode.R.string.brick_set_background);
		}
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_set_look_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			Spinner lookBrickSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.brick_set_look_spinner);
			TextView lookBrickTextView = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_set_look_prototype_text_view);
	...
	private ArrayAdapter<LookData> createLookAdapter(Context context) {
		...
		dummyLookData.setLookName(context.getString(hku.fyp14017.blencode.R.string.new_broadcast_message));
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_set_look, null);
		if (ProjectManager.getInstance().getCurrentSprite().getName().equals(context.getString(hku.fyp14017.blencode.R.string.background))) {
			TextView textField = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_set_look_prototype_text_view);
			textField.setText(hku.fyp14017.blencode.R.string.brick_set_background);
		}
		Spinner setLookSpinner = (Spinner) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_set_look_spinner);
	...
	private class SpinnerAdapterWrapper implements SpinnerAdapter {
		...
		public long getItemId(int paramInt) {
			...
			if (!currentLook.getLookName().equals(context.getString(hku.fyp14017.blencode.R.string.new_broadcast_message))) {
