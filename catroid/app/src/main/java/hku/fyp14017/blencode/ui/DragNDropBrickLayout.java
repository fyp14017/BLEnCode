...
public class DragNDropBrickLayout extends BrickLayout {
	...
	private void beginDrag(int x, int y, int itemIndex) {
		...
		dragCursor1 = makeWeirdFloatingWindow(View.inflate(getContext(), hku.fyp14017.blencode.R.layout.brick_user_data_insert, null));
		dragCursor2 = makeWeirdFloatingWindow(View.inflate(getContext(), hku.fyp14017.blencode.R.layout.brick_user_data_insert, null));
