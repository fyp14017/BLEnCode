...
import hku.fyp14017.blencode.ui.fragment.SoundFragment.OnSoundInfoListChangedAfterNewListener;
...
public class PlaySoundBrick extends BrickBaseType implements OnItemSelectedListener,
        SoundFragment.OnSoundInfoListChangedAfterNewListener {
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_play_sound, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_play_sound_checkbox);
		...
		final Spinner soundbrickSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.playsound_spinner);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_play_sound_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView playSoundLabel = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_play_sound_label);
			playSoundLabel.setTextColor(playSoundLabel.getTextColors().withAlpha(alphaValue));

			Spinner lookbrickSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.playsound_spinner);
	...
	private ArrayAdapter<SoundInfo> createSoundAdapter(Context context) {
		...
		dummySoundInfo.setTitle(context.getString(hku.fyp14017.blencode.R.string.new_broadcast_message));
	...
	public View getPrototypeView(Context context) {
		View prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_play_sound, null);
		Spinner playSoundSpinner = (Spinner) prototypeView.findViewById(hku.fyp14017.blencode.R.id.playsound_spinner);
	...
	private class SpinnerAdapterWrapper implements SpinnerAdapter {
		...
		public long getItemId(int paramInt) {
			...
			if (!currentSound.getTitle().equals(context.getString(hku.fyp14017.blencode.R.string.new_broadcast_message))) {
