...
public abstract class DroneMoveBrick extends FormulaBrick implements OnClickListener {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_drone_move, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_drone_move_checkbox);
		...
		TextView textTime = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_prototype_text_view_second);
		TextView editTime = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_edit_text_second);
		getFormulaWithBrickField(BrickField.DRONE_TIME_TO_FLY_IN_SECONDS)
				.setTextFieldId(hku.fyp14017.blencode.R.id.brick_drone_move_edit_text_second);
		getFormulaWithBrickField(BrickField.DRONE_TIME_TO_FLY_IN_SECONDS).refreshTextField(view);

		TextView times = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_text_view_second);
		...
		TextView label = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_label);
		...
		TextView textPower = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_prototype_text_view_power);
		TextView editPower = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_edit_text_power);
		getFormulaWithBrickField(BrickField.DRONE_POWER_IN_PERCENT)
				.setTextFieldId(hku.fyp14017.blencode.R.id.brick_drone_move_edit_text_power);
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_drone_move, null);
		TextView label = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_label);
		label.setText(getBrickLabel(prototypeView));
		TextView textTime = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_prototype_text_view_second);

        TextView times = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_text_view_second);
        TextView textPower = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_prototype_text_view_power);
	...
	public View getViewWithAlpha(int alphaValue) {
		if (view != null) {
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView textTimeLabel = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_label);
			TextView textPercent = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_set_power_to_percent);

			TextView textTimeSeconds = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_text_view_second);
			TextView editTime = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_edit_text_second);

			TextView textPower = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_text_view_power);
			TextView editPower = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_drone_move_edit_text_power);
	...
	public void onClick(View view) {
		...
		switch (view.getId()) {
			case hku.fyp14017.blencode.R.id.brick_drone_move_edit_text_second:
				FormulaEditorFragment.showFragment(view, this,
						getFormulaWithBrickField(BrickField.DRONE_TIME_TO_FLY_IN_SECONDS));
				break;

			case hku.fyp14017.blencode.R.id.brick_drone_move_edit_text_power:
				FormulaEditorFragment.showFragment(view, this,
						getFormulaWithBrickField(BrickField.DRONE_POWER_IN_PERCENT));
				break;
	...
	public int getRequiredResources() {
		return super.getRequiredResources() | ARDRONE_SUPPORT;
	}
}
