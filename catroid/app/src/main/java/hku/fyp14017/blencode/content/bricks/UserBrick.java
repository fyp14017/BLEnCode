...
public class UserBrick extends BrickBaseType implements OnClickListener {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_user, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_user_checkbox);
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_user, null);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		BrickLayout layout = (BrickLayout) view.findViewById(hku.fyp14017.blencode.R.id.brick_user_flow_layout);
	...
	public void onLayoutChanged(View currentView) {
		...
		BrickLayout layout = (BrickLayout) currentView.findViewById(hku.fyp14017.blencode.R.id.brick_user_flow_layout);
		...
		for (UserBrickParameter parameter : userBrickParameters) {
			...
			if (uiData.isVariable) {
				...
				if (prototype) {
					currentTextView.setTextAppearance(context, hku.fyp14017.blencode.R.style.BrickPrototypeTextView);
					try {
					...
					currentTextView.setTextAppearance(context, hku.fyp14017.blencode.R.style.BrickEditText);
				...
				currentTextView.setTextAppearance(context, hku.fyp14017.blencode.R.style.BrickText_Multiple);
