...
import hku.fyp14017.blencode.ui.LookViewHolder;
import hku.fyp14017.blencode.ui.ScriptActivity;
import hku.fyp14017.blencode.ui.ViewSwitchLock;
import hku.fyp14017.blencode.ui.adapter.LookAdapter;
import hku.fyp14017.blencode.ui.adapter.LookBaseAdapter;
import hku.fyp14017.blencode.ui.adapter.LookBaseAdapter.OnLookEditListener;
...
import hku.fyp14017.blencode.ui.dialogs.NewLookDialog;
import hku.fyp14017.blencode.ui.dialogs.RenameLookDialog;
import hku.fyp14017.blencode.utils.UtilCamera;
...
public class LookFragment extends ScriptActivityFragment implements OnLookEditListener,
	...
	private ActionMode.Callback copyModeCallBack = new ActionMode.Callback() {
		...
		public boolean onCreateActionMode(ActionMode mode, Menu menu) {
			...
			singleItemAppendixActionMode = getString(hku.fyp14017.blencode.R.string.look);
			multipleItemAppendixActionMode = getString(hku.fyp14017.blencode.R.string.looks);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(hku.fyp14017.blencode.R.layout.fragment_look, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			...
			if (uriIsSet) {
				String defLookName = getString(hku.fyp14017.blencode.R.string.default_look_name);
		...
		if (ProjectManager.getInstance().getCurrentSpritePosition() == 0) {
			TextView emptyViewHeading = (TextView) getActivity().findViewById(hku.fyp14017.blencode.R.id.fragment_look_text_heading);
			emptyViewHeading.setTextSize(TypedValue.COMPLEX_UNIT_SP, 60.0f);
			emptyViewHeading.setText(hku.fyp14017.blencode.R.string.backgrounds);
			TextView emptyViewDescription = (TextView) getActivity().findViewById(hku.fyp14017.blencode.R.id.fragment_look_text_description);
			emptyViewDescription.setText(hku.fyp14017.blencode.R.string.fragment_background_text_description);
		}

		adapter = new LookAdapter(getActivity(), hku.fyp14017.blencode.R.layout.fragment_look_looklist_item,
				hku.fyp14017.blencode.R.id.fragment_look_item_name_text_view, lookDataList, false);
	...
	public void onPrepareOptionsMenu(Menu menu) {
		...
		menu.findItem(hku.fyp14017.blencode.R.id.cut).setVisible(true);
		menu.findItem(hku.fyp14017.blencode.R.id.rename).setVisible(true);
		menu.findItem(hku.fyp14017.blencode.R.id.show_details).setVisible(true);
		menu.findItem(hku.fyp14017.blencode.R.id.settings).setVisible(true);
	...
	public void addLookFromCamera() {
		lookFromCameraUri = UtilCamera.getDefaultLookFromCameraUri(getString(hku.fyp14017.blencode.R.string.default_look_name));

		Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
		intent.putExtra(MediaStore.EXTRA_OUTPUT, lookFromCameraUri);

		Intent chooser = Intent.createChooser(intent, getString(hku.fyp14017.blencode.R.string.select_look_from_camera));
	...
	public void addLookDrawNewImage() {
		...
		bundleForPocketPaint
				.putString(Constants.EXTRA_PICTURE_NAME_POCKET_PAINT, getString(hku.fyp14017.blencode.R.string.default_look_name));
	...
	public void addLookChooseImage() {
		...
		bundleForPocketCode.putString(Constants.EXTRA_PICTURE_NAME_POCKET_PAINT, getString(hku.fyp14017.blencode.R.string.default_look_name));

		intent.setType("image/*");
		intent.putExtras(bundleForPocketCode);

		Intent chooser = Intent.createChooser(intent, getString(hku.fyp14017.blencode.R.string.select_look_from_gallery));
	...
	public View getView(int position, View convertView) {
		...
		if (convertView == null) {
			convertView = View.inflate(getActivity(), hku.fyp14017.blencode.R.layout.fragment_look_looklist_item, null);

			holder = new LookViewHolder();

			holder.lookImageView = (ImageView) convertView.findViewById(hku.fyp14017.blencode.R.id.fragment_look_item_image_view);
			holder.checkbox = (CheckBox) convertView.findViewById(hku.fyp14017.blencode.R.id.fragment_look_item_checkbox);
			holder.lookNameTextView = (TextView) convertView.findViewById(hku.fyp14017.blencode.R.id.fragment_look_item_name_text_view);
			holder.lookDetailsLinearLayout = (LinearLayout) convertView
					.findViewById(hku.fyp14017.blencode.R.id.fragment_look_item_detail_linear_layout);
			holder.lookFileSizeTextView = (TextView) holder.lookDetailsLinearLayout
					.findViewById(hku.fyp14017.blencode.R.id.fragment_look_item_size_text_view);
			holder.lookMeasureTextView = (TextView) holder.lookDetailsLinearLayout
					.findViewById(hku.fyp14017.blencode.R.id.fragment_look_item_measure_text_view);
			holder.lookArrowView = (ImageView) convertView.findViewById(hku.fyp14017.blencode.R.id.fragment_look_item_arrow_image_view);
			holder.lookElement = (RelativeLayout) convertView.findViewById(hku.fyp14017.blencode.R.id.fragment_look_item_relative_layout);
