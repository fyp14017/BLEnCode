...
import hku.fyp14017.blencode.io.ProjectScreenshotLoader;
...
public class ProjectAdapter extends ArrayAdapter<ProjectData> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (projectView == null) {
			projectView = inflater.inflate(hku.fyp14017.blencode.R.layout.activity_my_projects_list_item, parent, false);
			holder = new ViewHolder();
			holder.background = (RelativeLayout) projectView.findViewById(hku.fyp14017.blencode.R.id.my_projects_activity_item_background);
			holder.checkbox = (CheckBox) projectView.findViewById(hku.fyp14017.blencode.R.id.project_checkbox);
			holder.projectName = (TextView) projectView.findViewById(hku.fyp14017.blencode.R.id.my_projects_activity_project_title);
			holder.image = (ImageView) projectView.findViewById(hku.fyp14017.blencode.R.id.my_projects_activity_project_image);
			holder.size = (TextView) projectView.findViewById(hku.fyp14017.blencode.R.id.my_projects_activity_size_of_project_2);
			holder.dateChanged = (TextView) projectView.findViewById(hku.fyp14017.blencode.R.id.my_projects_activity_project_changed_2);
			holder.projectDetails = projectView.findViewById(hku.fyp14017.blencode.R.id.my_projects_activity_list_item_details);
			holder.arrow = (ImageView) projectView.findViewById(hku.fyp14017.blencode.R.id.arrow_right);
			// temporarily removed - because of upcoming release, and bad performance of projectdescription
		...
		if (mediumDateFormat.format(projectLastModificationDate).equals(mediumDateFormat.format(now))) {
			projectLastModificationDateString = getContext().getString(hku.fyp14017.blencode.R.string.details_date_today) + " "
			...
			projectLastModificationDateString = getContext().getString(hku.fyp14017.blencode.R.string.details_date_yesterday);
		} else {
