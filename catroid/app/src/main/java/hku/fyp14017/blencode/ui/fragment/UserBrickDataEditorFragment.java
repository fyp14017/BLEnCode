...
import hku.fyp14017.blencode.ui.BrickLayout;
import hku.fyp14017.blencode.ui.DragAndDropBrickLayoutListener;
import hku.fyp14017.blencode.ui.DragNDropBrickLayout;
import hku.fyp14017.blencode.ui.LineBreakListener;
import hku.fyp14017.blencode.ui.ScriptActivity;
import hku.fyp14017.blencode.ui.dialogs.UserBrickEditElementDialog;
...
public class UserBrickDataEditorFragment extends SherlockFragment implements OnKeyListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getSherlockActivity().getSupportActionBar().setTitle(getString(hku.fyp14017.blencode.R.string.brick_data_editor_title));
	...
	public static void showFragment(View view, UserScriptDefinitionBrick brick) {
		...
		if (dataEditorFragment == null) {
			...
			fragTransaction.add(hku.fyp14017.blencode.R.id.script_fragment_container, dataEditorFragment, BRICK_DATA_EDITOR_FRAGMENT_TAG);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		fragmentView = inflater.inflate(hku.fyp14017.blencode.R.layout.fragment_brick_data_editor, container, false);
		...
		editorBrickSpace = (LinearLayout) fragmentView.findViewById(hku.fyp14017.blencode.R.id.brick_data_editor_brick_space);
	...
	public void addTextDialog() {
		...
		editElementDialog(indexOfNewText, "", false, hku.fyp14017.blencode.R.string.add_text, hku.fyp14017.blencode.R.string.text_hint);
	...
	public void addVariableDialog() {
		int indexOfNewVariableText = currentBrick.addVariableWithId(getActivity(), hku.fyp14017.blencode.R.string.new_user_brick_variable);
		editElementDialog(indexOfNewVariableText, "", false, hku.fyp14017.blencode.R.string.add_variable, hku.fyp14017.blencode.R.string.variable_hint);
	...
	public void click(int id) {
		...
		if (uiData != null && !uiData.isEditModeLineBreak) {
			int title = uiData.isVariable ? hku.fyp14017.blencode.R.string.edit_variable : hku.fyp14017.blencode.R.string.edit_text;
			int defaultText = uiData.isVariable ? hku.fyp14017.blencode.R.string.variable_hint : hku.fyp14017.blencode.R.string.text_hint;
	...
	private void deleteButtonClicked(View theView) {
		DragNDropBrickLayout layout = (DragNDropBrickLayout) brickView.findViewById(hku.fyp14017.blencode.R.id.brick_user_flow_layout);
		int found = -1;
	...
	public void updateBrickView() {
		...
		for (UserScriptDefinitionBrickElement uiData : currentBrick.getUserScriptDefinitionBrickElements().getUserScriptDefinitionBrickElementList()) {
			...
			if (uiData.isEditModeLineBreak) {
				dataView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_user_data_line_break, null);
			} else {
				if (uiData.isVariable) {
					dataView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_user_data_variable, null);
				} else {
					dataView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_user_data_text, null);
				}
			}

			TextView textView = (TextView) dataView.findViewById(hku.fyp14017.blencode.R.id.text_view);

			if (textView != null) {
				textView.setText(uiData.name);
			}
			Button button = (Button) dataView.findViewById(hku.fyp14017.blencode.R.id.button);
