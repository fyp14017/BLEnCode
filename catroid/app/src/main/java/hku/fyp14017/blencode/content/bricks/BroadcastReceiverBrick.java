...
public class BroadcastReceiverBrick extends ScriptBrick implements BroadcastMessage {
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		final Spinner broadcastSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.brick_broadcast_receive_spinner);
	...
	public View getPrototypeView(Context context) {
		...
		Spinner broadcastReceiverSpinner = (Spinner) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_broadcast_receive_spinner);
