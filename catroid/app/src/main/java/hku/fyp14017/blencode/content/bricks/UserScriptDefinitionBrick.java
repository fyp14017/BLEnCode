...
public class UserScriptDefinitionBrick extends ScriptBrick implements OnClickListener {
	...
	public View getView(final Context context, int brickId, final BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_user_definition, null);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_user_definition_checkbox);
	...
	public void onLayoutChanged(View currentView) {
		...
		LinearLayout layout = (LinearLayout) currentView.findViewById(hku.fyp14017.blencode.R.id.brick_user_definition_layout);
		...
		define.setTextAppearance(context, hku.fyp14017.blencode.R.style.BrickText);
		define.setText(context.getString(hku.fyp14017.blencode.R.string.define));
	...
	public View getViewWithAlpha(int alphaValue) {
		LinearLayout layout = (LinearLayout) view.findViewById(hku.fyp14017.blencode.R.id.brick_user_definition_layout);
