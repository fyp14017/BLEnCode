...
public class UserVariableAdapter extends BaseAdapter implements ScriptActivityAdapterInterface {
	...
	public UserVariableAdapter(Context context, List<UserVariable> brickVariables, List<UserVariable> spriteVariables,
		...
		this.itemLayout = hku.fyp14017.blencode.R.layout.fragment_formula_editor_variablelist_item;
		this.checkboxId = hku.fyp14017.blencode.R.id.fragment_formula_editor_variablelist_item_checkbox;
		this.textViewId = hku.fyp14017.blencode.R.id.fragment_formula_editor_variablelist_item_name_text_view;
		this.textViewId2 = hku.fyp14017.blencode.R.id.fragment_formula_editor_variablelist_item_value_text_view;
		this.linearLayoutGlobalId = hku.fyp14017.blencode.R.id.variablelist_global_headline;
		this.linearLayoutLocalId = hku.fyp14017.blencode.R.id.variablelist_local_headline;
		this.linearLayoutUserBrickId = hku.fyp14017.blencode.R.id.variablelist_userbrick_headline;
	}
