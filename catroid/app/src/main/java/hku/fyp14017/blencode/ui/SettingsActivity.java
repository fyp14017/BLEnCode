...
public class SettingsActivity extends SherlockPreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addPreferencesFromResource(hku.fyp14017.blencode.R.xml.preferences);

		ListPreference listPreference = (ListPreference) findPreference(getResources().getString(
				hku.fyp14017.blencode.R.string.preference_key_select_camera));
		...
		for (int id = 0; id < cameraCount; id++) {
			...
			switch (cameraInfo.facing) {
				case CameraInfo.CAMERA_FACING_FRONT:
					entries[id] = getResources().getText(hku.fyp14017.blencode.R.string.camera_facing_front);
					break;
				case CameraInfo.CAMERA_FACING_BACK:
					entries[id] = getResources().getText(hku.fyp14017.blencode.R.string.camera_facing_back);
					break;
				default:
		...
		actionBar.setTitle(hku.fyp14017.blencode.R.string.preference_title);
