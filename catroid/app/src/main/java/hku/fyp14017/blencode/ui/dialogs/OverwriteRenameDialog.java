...
public class OverwriteRenameDialog extends DialogFragment implements OnClickListener {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		View dialogView = LayoutInflater.from(context).inflate(hku.fyp14017.blencode.R.layout.dialog_overwrite_project, null);

		replaceButton = (RadioButton) dialogView.findViewById(hku.fyp14017.blencode.R.id.dialog_overwrite_project_radio_replace);
		replaceButton.setOnClickListener(this);
		renameButton = (RadioButton) dialogView.findViewById(hku.fyp14017.blencode.R.id.dialog_overwrite_project_radio_rename);
		...
		projectTextView = (TextView) dialogView.findViewById(hku.fyp14017.blencode.R.id.dialog_overwrite_project_edit_text);
		projectTextLine = dialogView.findViewById(hku.fyp14017.blencode.R.id.dialog_overwrite_project_edit_line);

		Dialog dialog = new AlertDialog.Builder(getActivity()).setView(dialogView).setTitle(hku.fyp14017.blencode.R.string.overwrite_text)
				.setPositiveButton(hku.fyp14017.blencode.R.string.ok, new DialogInterface.OnClickListener() {
					...
					@Override
					public void onClick(DialogInterface dialog, int which) {
						Toast.makeText(context, hku.fyp14017.blencode.R.string.notification_download_project_cancel, Toast.LENGTH_SHORT)
								.show();
					}
				}).create();
		...
		dialog.setOnKeyListener(new OnKeyListener() {
			...
			public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
				if (event.getAction() == KeyEvent.ACTION_DOWN && keyCode == KeyEvent.KEYCODE_ENTER) {
					...
					Toast.makeText(context, hku.fyp14017.blencode.R.string.notification_download_project_cancel, Toast.LENGTH_SHORT).show();
					return true;
				}
	...
	public void onClick(View view) {
		switch (view.getId()) {
			case hku.fyp14017.blencode.R.id.dialog_overwrite_project_radio_replace:
			...
			case hku.fyp14017.blencode.R.id.dialog_overwrite_project_radio_rename:
