...
public class Formula implements Serializable {
	...
	public void highlightTextField(View brickView, int orientation) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			highlightBackground = brickView.getResources().getDrawable(hku.fyp14017.blencode.R.drawable.textfield_pressed_android4);
		} else {
			highlightBackground = brickView.getResources().getDrawable(hku.fyp14017.blencode.R.drawable.textfield_pressed);
		}
	...
	public String getResultForComputeDialog(Context context) {
		...
		if (formulaTree.isLogicalOperator()) {
			...
			int logicalFormulaResultIdentifier = result ? hku.fyp14017.blencode.R.string.formula_editor_true : hku.fyp14017.blencode.R.string.formula_editor_false;
