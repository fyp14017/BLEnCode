...
public class UserBrickEditElementDialog extends SherlockDialogFragment {
	...
	public void onCancel(DialogInterface dialog) {
		...
		if (stringResourceOfTitle == hku.fyp14017.blencode.R.string.add_variable) {
	...
	public Dialog onCreateDialog(Bundle bundle) {
		final View dialogView = LayoutInflater.from(getActivity()).inflate(hku.fyp14017.blencode.R.layout.dialog_brick_editor_edit_element,
				(ViewGroup)fragmentView, false);

		EditText textField = (EditText) dialogView.findViewById(hku.fyp14017.blencode.R.id.dialog_brick_editor_edit_element_edit_text);
		...
		final Dialog dialogNewVariable = new AlertDialog.Builder(getActivity()).setView(dialogView)
				.setTitle(stringResourceOfTitle).setNegativeButton(hku.fyp14017.blencode.R.string.cancel_button, new OnClickListener() {
					@Override
	...
	private void handleOkButton(View dialogView) {
			EditText elementTextEditText = (EditText) dialogView
					.findViewById(hku.fyp14017.blencode.R.id.dialog_brick_editor_edit_element_edit_text);
