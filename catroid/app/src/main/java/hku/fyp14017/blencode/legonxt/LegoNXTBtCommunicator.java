 ...
 */
package hku.fyp14017.blencode.legonxt;
...
import hku.fyp14017.blencode.bluetooth.BluetoothConnection;
...
public class LegoNXTBtCommunicator extends LegoNXTCommunicator {
	 ...
	 * 
	 * @see <a href=
	 *      "http://lejos.sourcefhkue.net/forum/viewtopic.php?t=1991&highlight=android"
	 *      />
	...
	public void createNXTconnection() throws IOException {
		...
		switch (state) {
			...
			case ERROR_STILL_BONDING:
				sendToast(resources.getString(hku.fyp14017.blencode.R.string.no_paired_nxt));
			default:
	...
	public void destroyNXTconnection() throws IOException {
		...
		try {
			...
			sendToast(resources.getString(hku.fyp14017.blencode.R.string.problem_at_closing));
			Log.e(TAG, Log.getStackTraceString(ioException));
		}
	}
