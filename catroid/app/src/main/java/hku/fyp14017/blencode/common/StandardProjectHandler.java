...
import hku.fyp14017.blencode.drone.DroneBrickFactory;
...
import hku.fyp14017.blencode.formulaeditor.Functions;
...
import hku.fyp14017.blencode.soundrecorder.SoundRecorder;
...
public final class StandardProjectHandler {
	...
	public static Project createAndSaveStandardProject(Context context) throws IOException {
		String projectName = context.getString(hku.fyp14017.blencode.R.string.default_project_name);
	...
	public static Project createAndSaveStandardDroneProject(Context context) throws IOException {
		...
		String projectName = context.getString(hku.fyp14017.blencode.R.string.default_drone_project_name);
	...
	public static Project createAndSaveStandardDroneProject(String projectName, Context context) throws IOException,
		...
		String backgroundName = context.getString(hku.fyp14017.blencode.R.string.default_project_backgroundname);
		...
		backgroundImageScaleFactor = ImageEditing.calculateScaleFactorToScreenSize(
                hku.fyp14017.blencode.R.drawable.default_project_background, context);

		File backgroundFile = UtilFile.copyImageFromResourceIntoProject(projectName, backgroundName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_project_background, context, true,
		...
		//Takeoff sprite
		String takeOffSpriteName = context.getString(hku.fyp14017.blencode.R.string.default_drone_project_sprites_takeoff);

		File takeOffArrowFile = UtilFile.copyImageFromResourceIntoProject(projectName, takeOffSpriteName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_drone_project_orange_takeoff, context, true,
				backgroundImageScaleFactor);
		...
		//land Sprite start
		String landSpriteName = context.getString(hku.fyp14017.blencode.R.string.default_drone_project_srpites_land);

		File landArrowFile = UtilFile.copyImageFromResourceIntoProject(projectName, takeOffSpriteName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_drone_project_orange_land, context, true,
				backgroundImageScaleFactor);
		...
		//rotate Sprite start
		String rotateSpriteName = context.getString(hku.fyp14017.blencode.R.string.default_drone_project_srpites_rotate);

		File rotateFile = UtilFile.copyImageFromResourceIntoProject(projectName, rotateSpriteName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_drone_project_orange_rotate, context, true,
				backgroundImageScaleFactor);
		...
		//Up Sprite
		String upSpriteName = context.getString(hku.fyp14017.blencode.R.string.default_drone_project_sprites_up);

		File upFile = UtilFile.copyImageFromResourceIntoProject(projectName, upSpriteName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_drone_project_orange_arrow_up, context, true,
				backgroundImageScaleFactor);
		...
		//Down Sprite
		String downSpriteName = context.getString(hku.fyp14017.blencode.R.string.default_drone_project_sprites_down);

		File downFile = UtilFile.copyImageFromResourceIntoProject(projectName, downSpriteName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_drone_project_orange_arrow_down, context,
				true, backgroundImageScaleFactor);
		...
		//Forward Sprite
		String forwardSpriteName = context.getString(hku.fyp14017.blencode.R.string.default_drone_project_sprites_forward);

		File forwardFile = UtilFile.copyImageFromResourceIntoProject(projectName, forwardSpriteName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_drone_project_orange_go_forward, context,
				true, backgroundImageScaleFactor);
		...
		//Backward Sprite
		String backwardpriteName = context.getString(hku.fyp14017.blencode.R.string.default_drone_project_sprites_back);

		File backwardFile = UtilFile.copyImageFromResourceIntoProject(projectName, downSpriteName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_drone_project_orange_go_back, context, true,
				backgroundImageScaleFactor);
		...
		//Left Sprite
		String leftSpriteName = context.getString(hku.fyp14017.blencode.R.string.default_drone_project_sprites_left);

		File leftFile = UtilFile.copyImageFromResourceIntoProject(projectName, leftSpriteName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_drone_project_orange_go_left, context, true,
				backgroundImageScaleFactor);
		...
		//Right Sprite
		String rightSpriteName = context.getString(hku.fyp14017.blencode.R.string.default_drone_project_sprites_right);

		File rightFile = UtilFile.copyImageFromResourceIntoProject(projectName, rightSpriteName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_drone_project_orange_go_right, context, true,
				backgroundImageScaleFactor);
		...
		//Turn Left Sprite
		String turnLeftSpriteName = context.getString(hku.fyp14017.blencode.R.string.default_drone_project_sprites_turn_left);

		File turnLeftFile = UtilFile.copyImageFromResourceIntoProject(projectName, turnLeftSpriteName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_drone_project_orange_turn_left, context, true,
				backgroundImageScaleFactor);
		...
		//Turn Right Sprite
		String turnRightSpriteName = context.getString(hku.fyp14017.blencode.R.string.default_drone_project_sprites_turn_right);

		File turnrightFile = UtilFile.copyImageFromResourceIntoProject(projectName, turnRightSpriteName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_drone_project_orange_turn_right, context,
				true, backgroundImageScaleFactor);
	...
	public static Project createAndSaveStandardProject(String projectName, Context context) throws IOException,
		...
		String moleLookName = context.getString(hku.fyp14017.blencode.R.string.default_project_sprites_mole_name);
		...
		String whackedMoleLookName = context.getString(hku.fyp14017.blencode.R.string.default_project_sprites_mole_whacked);
		String movingMoleLookName = context.getString(hku.fyp14017.blencode.R.string.default_project_sprites_mole_moving);
		String soundName = context.getString(hku.fyp14017.blencode.R.string.default_project_sprites_mole_sound);
		String backgroundName = context.getString(hku.fyp14017.blencode.R.string.default_project_backgroundname);

		String varRandomFrom = context.getString(hku.fyp14017.blencode.R.string.default_project_var_random_from);
		String varRandomTo = context.getString(hku.fyp14017.blencode.R.string.default_project_var_random_to);
		...
		File movingMoleFile = UtilFile.copyImageFromResourceIntoProject(projectName, movingMoleLookName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_project_mole_moving, context, true,
				backgroundImageScaleFactor);
		File diggedOutMoleFile = UtilFile.copyImageFromResourceIntoProject(projectName, moleLookName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_project_mole_digged_out, context, true,
				backgroundImageScaleFactor);
		File whackedMoleFile = UtilFile.copyImageFromResourceIntoProject(projectName, whackedMoleLookName
				+ Constants.IMAGE_STANDARD_EXTENTION, hku.fyp14017.blencode.R.drawable.default_project_mole_whacked, context, true,
				backgroundImageScaleFactor);
		try {
			File soundFile1 = UtilFile.copySoundFromResourceIntoProject(projectName, soundName + "1"
					+ SoundRecorder.RECORDING_EXTENSION, hku.fyp14017.blencode.R.raw.default_project_sound_mole_1, context, true);
			File soundFile2 = UtilFile.copySoundFromResourceIntoProject(projectName, soundName + "2"
					+ SoundRecorder.RECORDING_EXTENSION, hku.fyp14017.blencode.R.raw.default_project_sound_mole_2, context, true);
			File soundFile3 = UtilFile.copySoundFromResourceIntoProject(projectName, soundName + "3"
					+ SoundRecorder.RECORDING_EXTENSION, hku.fyp14017.blencode.R.raw.default_project_sound_mole_3, context, true);
			File soundFile4 = UtilFile.copySoundFromResourceIntoProject(projectName, soundName + "4"
					+ SoundRecorder.RECORDING_EXTENSION, hku.fyp14017.blencode.R.raw.default_project_sound_mole_4, context, true);
			UtilFile.copyFromResourceIntoProject(projectName, ".", StageListener.SCREENSHOT_AUTOMATIC_FILE_NAME,
					hku.fyp14017.blencode.R.drawable.default_project_screenshot, context, false);
