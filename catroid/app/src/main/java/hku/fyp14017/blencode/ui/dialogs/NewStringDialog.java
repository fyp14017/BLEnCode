...
public class NewStringDialog extends SherlockDialogFragment {
	...
	public Dialog onCreateDialog(Bundle bundle) {
		...
		final View dialogView = LayoutInflater.from(getActivity()).inflate(hku.fyp14017.blencode.R.layout.dialog_formulaeditor_string, root, false);

		newStringDialog = new AlertDialog.Builder(getActivity()).setView(dialogView)
				.setTitle(hku.fyp14017.blencode.R.string.formula_editor_new_string_name)
		...
		newStringEditText = (EditText) dialogView.findViewById(hku.fyp14017.blencode.R.id.formula_editor_string_name_edit_text);
