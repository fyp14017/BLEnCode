...
public class PointInDirectionBrick extends FormulaBrick implements View.OnClickListener {
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_point_in_direction, null);
		view = getViewWithAlpha(alphaValue);
		setCheckboxView(hku.fyp14017.blencode.R.id.brick_point_in_direction_checkbox);
		...
		TextView setAngleTextView = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_point_in_direction_prototype_text_view);
		TextView setAngleTextField = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_point_in_direction_edit_text);

		getFormulaWithBrickField(BrickField.DEGREES).setTextFieldId(hku.fyp14017.blencode.R.id.brick_point_in_direction_edit_text);
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_point_in_direction, null);
		TextView setAngleTextView = (TextView) prototypeView
				.findViewById(hku.fyp14017.blencode.R.id.brick_point_in_direction_prototype_text_view);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_point_in_direction_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView pointInDirectionLabel = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_point_in_direction_label);
			TextView pointInDirectionDegree = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_point_in_direction_degree);
			TextView setAngleTextView = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_point_in_direction_edit_text);
