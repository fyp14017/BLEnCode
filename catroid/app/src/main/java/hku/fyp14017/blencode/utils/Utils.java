 ...
 * 	manningr@users.sourcefhkue.net
...
import hku.fyp14017.blencode.exceptions.ProjectException;
...
public final class Utils {
	...
	public static boolean checkForExternalStorageAvailableAndDisplayErrorIfNot(final Context context) {
		if (!externalStorageAvailable()) {
			...
			builder.setTitle(hku.fyp14017.blencode.R.string.error);
			builder.setMessage(hku.fyp14017.blencode.R.string.error_no_writiable_external_storage_available);
			builder.setNeutralButton(hku.fyp14017.blencode.R.string.close, new OnClickListener() {
				@Override
	...
	public static View addSelectAllActionModeButton(LayoutInflater inflater, ActionMode mode, Menu menu) {
		mode.getMenuInflater().inflate(hku.fyp14017.blencode.R.menu.menu_actionmode, menu);
		MenuItem item = menu.findItem(hku.fyp14017.blencode.R.id.select_all);
		View view = item.getActionView();
		if (view.getId() == hku.fyp14017.blencode.R.id.select_all) {
			View selectAllView = inflater.inflate(hku.fyp14017.blencode.R.layout.action_mode_select_all, null);
	...
	public static void loadProjectIfNeeded(Context context) {
		if (ProjectManager.getInstance().getCurrentProject() == null) {
			...
			if (projectName == null || !StorageHandler.getInstance().projectExists(projectName)) {
				projectName = context.getString(hku.fyp14017.blencode.R.string.default_project_name);
			}
	...
	public static void rewriteImageFileForStage(Context context, File lookFile) throws IOException {
		...
		if (pixmap == null) {
			...
			if (pixmap == null) {
				Utils.showErrorDialog(context, hku.fyp14017.blencode.R.string.error_load_image);
