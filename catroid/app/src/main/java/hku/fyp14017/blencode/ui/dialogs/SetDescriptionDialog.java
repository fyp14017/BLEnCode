...
public class SetDescriptionDialog extends MultiLineTextDialog {
	...
	protected boolean handleOkButton() {
		...
		try {
			...
			Log.e(DIALOG_FRAGMENT_TAG, "Changing description of an incompatible project isn\'t possible.",
					projectException);
			Utils.showErrorDialog(getActivity(), hku.fyp14017.blencode.R.string.error_changing_description_of_incompatible_project);
			dismiss();
			return false;
		}
	...
	protected String getTitle() {
		return getString(hku.fyp14017.blencode.R.string.set_description);
	}
