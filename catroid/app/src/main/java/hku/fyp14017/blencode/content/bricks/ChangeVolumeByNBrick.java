...
public class ChangeVolumeByNBrick extends FormulaBrick implements OnClickListener {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_change_volume_by, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_change_volume_by_checkbox);
		...
		TextView text = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_change_volume_by_prototype_text_view);
		TextView edit = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_change_volume_by_edit_text);
		getFormulaWithBrickField(BrickField.VOLUME_CHANGE).setTextFieldId(hku.fyp14017.blencode.R.id.brick_change_volume_by_edit_text);
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_change_volume_by, null);
		TextView textSetVolumenTo = (TextView) prototypeView
				.findViewById(hku.fyp14017.blencode.R.id.brick_change_volume_by_prototype_text_view);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_change_volume_by_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView changeVolume = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_change_volume_by_label);
			TextView editVolume = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_change_volume_by_edit_text);
