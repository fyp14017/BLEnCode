...
public class LegoNxtMotorActionBrick extends FormulaBrick implements OnClickListener {
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_nxt_motor_action, null);
		TextView textSpeed = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.motor_action_speed_text_view);
		textSpeed.setText(String.valueOf(BrickValues.LEGO_SPEED));

		Spinner legoSpinner = (Spinner) prototypeView.findViewById(hku.fyp14017.blencode.R.id.lego_motor_action_spinner);
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_nxt_motor_action, null);
		view = getViewWithAlpha(alphaValue);
		setCheckboxView(hku.fyp14017.blencode.R.id.brick_nxt_motor_action_checkbox);
		...
		TextView textSpeed = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.motor_action_speed_text_view);
		editSpeed = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.motor_action_speed_edit_text);
		getFormulaWithBrickField(BrickField.LEGO_NXT_SPEED).setTextFieldId(hku.fyp14017.blencode.R.id.motor_action_speed_edit_text);
		...
		ArrayAdapter<CharSequence> motorAdapter = ArrayAdapter.createFromResource(context, hku.fyp14017.blencode.R.array.nxt_motor_chooser,
				android.R.layout.simple_spinner_item);
		motorAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		Spinner motorSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.lego_motor_action_spinner);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_nxt_motor_action_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView textLegoMotorActionLabel = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.lego_motor_action_label);
			TextView textLegoMotorActionSpeed = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.lego_motor_action_speed);
			TextView textLegoMotorActionPercent = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.lego_motor_action_percent);
			TextView textLegoMotorActionLabelSpeedView = (TextView) view
					.findViewById(hku.fyp14017.blencode.R.id.motor_action_speed_text_view);
			TextView editSpeed = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.motor_action_speed_edit_text);
