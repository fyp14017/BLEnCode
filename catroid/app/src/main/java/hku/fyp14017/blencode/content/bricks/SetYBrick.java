...
public class SetYBrick extends FormulaBrick implements OnClickListener {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_set_y, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_set_y_checkbox);
		...
		TextView textY = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_set_y_prototype_text_view);
		TextView editY = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_set_y_edit_text);
		getFormulaWithBrickField(BrickField.Y_POSITION).setTextFieldId(hku.fyp14017.blencode.R.id.brick_set_y_edit_text);
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_set_y, null);
		TextView textYPosition = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_set_y_prototype_text_view);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_set_y_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView textY = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_set_y_textview);
			TextView editY = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_set_y_edit_text);
