...
public class FormulaEditorVariableListFragment extends SherlockListFragment implements Dialog.OnKeyListener,
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View fragmentView = inflater.inflate(hku.fyp14017.blencode.R.layout.fragment_formula_editor_variablelist, container, false);
		return fragmentView;
	}
	...
	public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfo) {
		if (!inContextMode) {
			...
			getSherlockActivity().getMenuInflater().inflate(hku.fyp14017.blencode.R.menu.menu_formulaeditor_variablelist, menu);
		}
	}
	...
	private void updateActionModeTitle() {
		String title = adapter.getAmountOfCheckedItems()
				...
				+ getActivity().getResources().getQuantityString(
						hku.fyp14017.blencode.R.plurals.formula_editor_variable_context_action_item_selected,
	...
	public void setAddButtonListener(SherlockFragmentActivity sherlockActivity) {
		ImageButton buttonAdd = (ImageButton) sherlockActivity.findViewById(hku.fyp14017.blencode.R.id.button_add);
	...
	public boolean onContextItemSelected(android.view.MenuItem item) {
		...
		switch (item.getItemId()) {
			case hku.fyp14017.blencode.R.id.menu_delete:
				if (!adapter.isEmpty()) {
	...
	private ActionMode.Callback contextModeCallback = new ActionMode.Callback() {
		...
		public boolean onCreateActionMode(ActionMode mode, Menu menu) {
			...
			mode.setTitle("0 "
					+ getActivity().getResources().getQuantityString(
							hku.fyp14017.blencode.R.plurals.formula_editor_variable_context_action_item_selected, 0));
			BottomBar.hideBottomBar(getActivity());
		...
		public void onDestroyActionMode(ActionMode mode) {
			...
			contextActionMode = null;
			inContextMode = false;
			getSherlockActivity().findViewById(hku.fyp14017.blencode.R.id.bottom_bar).setVisibility(View.VISIBLE);
		}
	};
}
