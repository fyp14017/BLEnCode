 ...
 */
package hku.fyp14017.blencode.ui.controller;
...
public final class SoundController {
	...
	private void handleSoundInfo(SoundViewHolder holder, SoundInfo soundInfo, SoundBaseAdapter soundAdapter,
		...
		try {
			...
			if (soundInfo.isPlaying) {
				...
				holder.playAndStopButton.setContentDescription(context.getString(hku.fyp14017.blencode.R.string.sound_stop));
				...
				holder.playAndStopButton.setContentDescription(context.getString(hku.fyp14017.blencode.R.string.sound_play));
				stopPlayingSound(soundInfo, holder.timePlayedChronometer, soundAdapter);
			}
	...
	private void handleCheckboxes(final int position, SoundViewHolder holder, final SoundBaseAdapter soundAdapter) {
		...
		if (soundAdapter.getSelectMode() != ListView.CHOICE_MODE_NONE) {
			...
			holder.checkbox.setVisibility(View.VISIBLE);
			holder.soundFragmentButtonLayout.setBackgroundResource(hku.fyp14017.blencode.R.drawable.button_background_shadowed);
		} else {
			holder.checkbox.setVisibility(View.GONE);
			holder.checkbox.setVisibility(View.GONE);
			holder.soundFragmentButtonLayout.setBackgroundResource(hku.fyp14017.blencode.R.drawable.button_background_selector);
