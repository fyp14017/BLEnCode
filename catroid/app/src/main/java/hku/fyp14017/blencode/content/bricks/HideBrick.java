...
public class HideBrick extends BrickBaseType {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_hide, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_hide_checkbox);
	...
	public View getViewWithAlpha(int alphaValue) {
		if (view != null) {
			Log.d("TAG", "VIEW != NULL");
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_hide_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);
			this.alphaValue = (alphaValue);

			TextView hideLabel = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_hide_label);
	...
	public View getPrototypeView(Context context) {
		return View.inflate(context, hku.fyp14017.blencode.R.layout.brick_hide, null);
	}
