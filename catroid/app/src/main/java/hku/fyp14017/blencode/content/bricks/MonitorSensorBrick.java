...
public class MonitorSensorBrick extends BrickBaseType implements OnItemSelectedListener {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_ble_monitor_sensor, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_ble_monitor_checkbox);
		...
		ArrayAdapter<CharSequence> motorAdapter = ArrayAdapter.createFromResource(context, hku.fyp14017.blencode.R.array.sensor_chooser,
				android.R.layout.simple_spinner_item);
		motorAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

		Spinner motorSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.sensor_spinner);
        ...
        Spinner sensorTagSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.tag_spinner);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_ble_monitor_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView TempLabel = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.ble_monitor_label);
	...
	public View getPrototypeView(Context context) {
		View prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_ble_monitor_sensor, null);
		Spinner bleSpinner = (Spinner) prototypeView.findViewById(hku.fyp14017.blencode.R.id.sensor_spinner);
		bleSpinner.setFocusableInTouchMode(false);
		bleSpinner.setFocusable(false);
		ArrayAdapter<CharSequence> SensorAdapter = ArrayAdapter.createFromResource(context, hku.fyp14017.blencode.R.array.sensor_chooser,
				android.R.layout.simple_spinner_item);
        ...
        Spinner sensorTagSpinner = (Spinner) prototypeView.findViewById(hku.fyp14017.blencode.R.id.tag_spinner);
        sensorTagSpinner.setFocusable(false);
        sensorTagSpinner.setFocusableInTouchMode(false);

        ArrayAdapter<CharSequence> tagAdapter = ArrayAdapter.createFromResource(context, hku.fyp14017.blencode.R.array.sensortag_chooser,
                android.R.layout.simple_spinner_item);
        SensorAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
