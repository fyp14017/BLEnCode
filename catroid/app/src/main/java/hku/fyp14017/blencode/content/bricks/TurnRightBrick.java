...
public class TurnRightBrick extends FormulaBrick implements OnClickListener {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_turn_right, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_turn_right_checkbox);
		...
		TextView textDegrees = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_turn_right_prototype_text_view);
		TextView editDegrees = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_turn_right_edit_text);
		getFormulaWithBrickField(BrickField.TURN_RIGHT_DEGREES).setTextFieldId(hku.fyp14017.blencode.R.id.brick_turn_right_edit_text);
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_turn_right, null);
		TextView textDegrees = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.brick_turn_right_prototype_text_view);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_turn_right_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView turnRightLabel = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_turn_right_label);
			TextView textDegrees = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_turn_right_prototype_text_view);
			TextView degreeSymbol = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_turn_right_degree_text_view);
			TextView editDegrees = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_turn_right_edit_text);
