...
public final class StatusBarNotificationManager {
	...
	public int createUploadNotification(Context context, String programName) {
		...
		NotificationData data = new NotificationData(context, pendingIntent, hku.fyp14017.blencode.R.drawable.ic_stat, programName,
				hku.fyp14017.blencode.R.string.notification_upload_title_pending, hku.fyp14017.blencode.R.string.notification_upload_title_finished,
				hku.fyp14017.blencode.R.string.notification_upload_pending, hku.fyp14017.blencode.R.string.notification_upload_finished);
	...
	public int createCopyNotification(Context context, String programName) {
		...
		NotificationData data = new NotificationData(context, pendingIntent, hku.fyp14017.blencode.R.drawable.ic_stat, programName,
				hku.fyp14017.blencode.R.string.notification_copy_title_pending, hku.fyp14017.blencode.R.string.notification_title_open,
				hku.fyp14017.blencode.R.string.notification_copy_pending, hku.fyp14017.blencode.R.string.notification_copy_finished);
	...
	public int createDownloadNotification(Context context, String programName) {
		...
		NotificationData data = new NotificationData(context, pendingIntent, hku.fyp14017.blencode.R.drawable.ic_stat, programName,
				hku.fyp14017.blencode.R.string.notification_download_title_pending, hku.fyp14017.blencode.R.string.notification_title_open,
				hku.fyp14017.blencode.R.string.notification_download_pending, hku.fyp14017.blencode.R.string.notification_download_finished);
