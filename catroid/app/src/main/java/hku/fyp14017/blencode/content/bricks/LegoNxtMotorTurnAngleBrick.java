...
public class LegoNxtMotorTurnAngleBrick extends FormulaBrick implements OnClickListener {
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_nxt_motor_turn_angle, null);
		TextView textX = (TextView) prototypeView.findViewById(hku.fyp14017.blencode.R.id.motor_turn_angle_text_view);
		textX.setText(String.valueOf(BrickValues.LEGO_ANGLE));

		Spinner legoSpinner = (Spinner) prototypeView.findViewById(hku.fyp14017.blencode.R.id.lego_motor_turn_angle_spinner);
		legoSpinner.setFocusableInTouchMode(false);
		legoSpinner.setFocusable(false);

		ArrayAdapter<CharSequence> motorAdapter = ArrayAdapter.createFromResource(context, hku.fyp14017.blencode.R.array.nxt_motor_chooser,
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_nxt_motor_turn_angle, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(hku.fyp14017.blencode.R.id.brick_nxt_motor_turn_checkbox);
		...
		TextView textSpeed = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.motor_turn_angle_text_view);
		editSpeed = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.motor_turn_angle_edit_text);
		getFormulaWithBrickField(BrickField.LEGO_NXT_DEGREES).setTextFieldId(hku.fyp14017.blencode.R.id.motor_turn_angle_edit_text);
		...
		Spinner motorSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.lego_motor_turn_angle_spinner);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(hku.fyp14017.blencode.R.id.brick_nxt_motor_turn_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView textLegoTurnAngleLabel = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_nxt_motor_turn_label);
			TextView textLegoTurnAngleTextView = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_nxt_motor_turn_angle);
			TextView textLegoTurnAngleView = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.motor_turn_angle_text_view);
			TextView textLegoTurnAngleDegree = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.brick_nxt_motor_turn_degree);
			TextView editLegoSpeed = (TextView) view.findViewById(hku.fyp14017.blencode.R.id.motor_turn_angle_edit_text);
