...
public class ConnectSensorTagBrick extends BrickBaseType implements OnItemSelectedListener {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_ble_connect_sensor_tag, null);
        ...
        Spinner sensorTagSpinner = (Spinner) view.findViewById(hku.fyp14017.blencode.R.id.connect_sensortag_spinner);
	...
	public View getPrototypeView(Context context) {
		View prototypeView = View.inflate(context, hku.fyp14017.blencode.R.layout.brick_ble_connect_sensor_tag, null);
        Spinner sensorTagSpinner = (Spinner) prototypeView.findViewById(hku.fyp14017.blencode.R.id.connect_sensortag_spinner);
