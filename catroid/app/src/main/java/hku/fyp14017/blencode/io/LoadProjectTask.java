...
public class LoadProjectTask extends AsyncTask<Void, Void, Boolean> {
	...
	protected void onPreExecute() {
		...
		linearLayoutProgressCircle = (LinearLayout) activity.findViewById(hku.fyp14017.blencode.R.id.progress_circle);
	...
	protected void onPostExecute(Boolean success) {
		...
		if (onLoadProjectCompleteListener != null) {
			if (!success && showErrorMessage) {
				...
				builder.setMessage(hku.fyp14017.blencode.R.string.error_load_project);
